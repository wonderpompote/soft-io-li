...
def histogram_using_pandas(_ds, data_var_name, min_bin_edge, max_bin_edge, step,
                           groupby_dims=['latitude', 'longitude'], res_var_name=None):
    """
    ...
    groupby_dims.append(f'{data_var_name}_edges')
...
def count_using_pandas(_ds, data_var_name, groupby_dims=['latitude', 'longitude'], res_var_name=None):
    """
