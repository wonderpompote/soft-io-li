...
PRE_REGRID_GLM_ROOT_DIR = pathlib.Path('/o3p/patj/test-glm/pre_regrid_hourly_glm/') #TODO modif après fin des tests pathlib.Path('/o3p/patj/glm/pre_regrid_hourly_glm/')
